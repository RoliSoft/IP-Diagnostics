...
function detect_browser_version($title){
	...
	$start=$title;
	if((strtolower($title)==strtolower("Opera") || strtolower($title)==strtolower("Opera Next") 
		|| strtolower($title)==strtolower("Opera Labs")) && preg_match('/Version/i', $_SERVER['HTTP_USER_AGENT']))
		$start="Version";
	...
	{
		preg_match('/Edition\ Labs([\ ._0-9a-zA-Z]+);/i', $_SERVER['HTTP_USER_AGENT'], $regmatch);
...
function detect_webbrowser(){
	...
	if(preg_match('/360se/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="acoobrowser";
	}elseif(preg_match('/Alienforce/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="arora";
	}elseif(preg_match('/AtomicBrowser/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="avantbrowser";
	}elseif(preg_match('/baidubrowser/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="caymanbrowser";
	}elseif(preg_match('/Charon/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="chromium";
	}elseif(preg_match('/Classilla/i', $_SERVER['HTTP_USER_AGENT'])){
		$link="http://en.wikipedia.org/wiki/Classilla";
		$title=detect_browser_version("Classilla");
		$code="classilla";
	}elseif(preg_match('/Columbus/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="conkeror";
	}elseif(preg_match('/CoolNovo/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="crazybrowser";
	}elseif(preg_match('/CrMo/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="doris";
	}elseif(preg_match('/Dorothy/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="enigmabrowser";
	}elseif(preg_match('/EnigmaFox/i', $_SERVER['HTTP_USER_AGENT'])){
		$link="#";
		...
		$code="firebird";
	}elseif(preg_match('/Fireweb\ Navigator/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="konqueror";
	}elseif(preg_match('/Kylo/i', $_SERVER['HTTP_USER_AGENT'])){
		$link="http://kylo.tv/";
		...
		$title="LeechCraft";
		$code="null";
	}elseif(preg_match('/Links/i', $_SERVER['HTTP_USER_AGENT']) && !preg_match('/online\ link\ validator/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="netfront";
	}elseif(preg_match('/NokiaBrowser/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="opera-2";
	}elseif(preg_match('/Opera Labs/i', $_SERVER['HTTP_USER_AGENT']) || (preg_match('/Opera/i', $_SERVER['HTTP_USER_AGENT']) && preg_match('/Edition Labs/i', $_SERVER['HTTP_USER_AGENT']))){
		$link="http://labs.opera.com/";
		$title=detect_browser_version("Opera Labs");
		$code="opera-next";
	}elseif(preg_match('/Opera Next/i', $_SERVER['HTTP_USER_AGENT']) || (preg_match('/Opera/i', $_SERVER['HTTP_USER_AGENT']) && preg_match('/Edition Next/i', $_SERVER['HTTP_USER_AGENT']))){
		...
		$code="palemoon";
	}elseif(preg_match('/Patriott\:\:Browser/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="phoenix";
	}elseif(preg_match('/Podkicker/i', $_SERVER['HTTP_USER_AGENT'])){
		$link="http://www.podkicker.com/";
		$title=detect_browser_version("Podkicker");
		$code="podkicker";
	}elseif(preg_match('/Podkicker\ Pro/i', $_SERVER['HTTP_USER_AGENT'])){
		$link="http://www.podkicker.com/";
	...
	}elseif(preg_match('/QupZilla/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="slimbrowser";
	}elseif(preg_match('/SmartTV/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="flock";
	}elseif(preg_match('/Sundance/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="swiftweasel";
	}elseif(preg_match('/Sylera/i', $_SERVER['HTTP_USER_AGENT'])){
	...
	}elseif(preg_match('/TenFourFox/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="thunderbird";
	}elseif(preg_match('/Tizen/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="openwave";
	}elseif(preg_match('/Usejump/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="w3m";
	}elseif(preg_match('/AppleWebkit/i', $_SERVER['HTTP_USER_AGENT']) && preg_match('/Android/i', $_SERVER['HTTP_USER_AGENT'])){
		$link="http://developer.android.com/reference/android/webkit/package-summary.html";
		$title=detect_browser_version("Android Webkit");
		$code="android-webkit";
	}elseif(preg_match('/WebianShell/i', $_SERVER['HTTP_USER_AGENT'])){
		$link="http://webian.org/shell/";
		$title="Webian ".detect_browser_version("Shell");
		$code="webianshell";
	}elseif(preg_match('/Webrender/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$code="null";
	}elseif(preg_match('/ZipZap/i', $_SERVER['HTTP_USER_AGENT'])){
...
function detect_device(){
	...
	//Microsoft
	}elseif(preg_match('/Windows Phone OS 7.0/i', $_SERVER['HTTP_USER_AGENT']) || preg_match('/ZuneWP7/i', $_SERVER['HTTP_USER_AGENT']) || preg_match('/WP7/i', $_SERVER['HTTP_USER_AGENT'])){
	...
	//Motorola
		...
		if(preg_match('/MOT-([.0-9a-zA-Z]+)/i', $_SERVER['HTTP_USER_AGENT'], $regmatch))
			$title.=" ".$regmatch[1];
		$code="motorola";
	}elseif(preg_match('/XOOM/i', $_SERVER['HTTP_USER_AGENT'])){
	...
	//Samsung
	}elseif(preg_match('/Galaxy Nexus/i', $_SERVER['HTTP_USER_AGENT'])){
...
function detect_os(){
	if(preg_match('/AmigaOS/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		$title="Android";
		$code="android";
		if(preg_match('/Android[\ |\/]?([.0-9a-zA-Z]+)/i', $_SERVER['HTTP_USER_AGENT'], $regmatch)){
			$version=$regmatch[1];
			$title.=" ".$version;
		}
		if(preg_match('/x86_64/i', $_SERVER['HTTP_USER_AGENT']))
		...
		if(preg_match('/x86_64/i', $_SERVER['HTTP_USER_AGENT']))
			$title.=" x64";
	}elseif(preg_match('/Chakra/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		if(preg_match('/x86_64/i', $_SERVER['HTTP_USER_AGENT']))
			$title.=" x64";
	}elseif(preg_match('/Crunchbang/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		if(preg_match('/x86_64/i', $_SERVER['HTTP_USER_AGENT']))
			$title.=" x64";
	}elseif(preg_match('/Inferno/i', $_SERVER['HTTP_USER_AGENT'])){
	...
	}elseif(preg_match('/Mageia/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		if(preg_match('/x86_64/i', $_SERVER['HTTP_USER_AGENT']))
			$title.=" x64";
	}elseif(preg_match('/Nova/i', $_SERVER['HTTP_USER_AGENT'])){
		$link="http://www.nova.cu";
		$title="Nova";
		if(preg_match('/Nova[\/|\ ]([.0-9a-zA-Z]+)/i', $_SERVER['HTTP_USER_AGENT'], $regmatch))
			$version.=" ".$regmatch[1];
		if(strlen($version) > 1)
			$title.=$version;
		$code="nova";
		...
		if(preg_match('/x86_64/i', $_SERVER['HTTP_USER_AGENT']))
			$title.=" x64";
	}elseif(preg_match('/Pardus/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		if(preg_match('/x86_64/i', $_SERVER['HTTP_USER_AGENT']))
			$title.=" x64";
	}elseif(preg_match('/Rosa/i', $_SERVER['HTTP_USER_AGENT'])){
		...
		if(preg_match('/Windows NT 6.2; Win64; x64;/i', $_SERVER['HTTP_USER_AGENT']) || preg_match('/Windows NT 6.2; WOW64/i', $_SERVER['HTTP_USER_AGENT'])){
